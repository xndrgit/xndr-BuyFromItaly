<template>
    <div :class="{ 'menu': true, 'centered-menu': isMenuCentered }">
        ...
        <li style="--x:0;--color:#1877f2">
            <a href="#"><i aria-hidden="true" class="fa-brands fa-facebook"></i></a>
        </li>
        <li style="--x:1;--color:#25d366">
            <a href="#"><i aria-hidden="true" class="fa-brands fa-whatsapp"></i></a>
        </li>
        <li style="--x:2;--color:#1da1f2">
            <a href="#"><i aria-hidden="true" class="fa-brands fa-twitter"></i></a>
        </li>
        <li style="--x:3;--color:#FF5733">
            <a href="#"><i aria-hidden="true" class="fa-brands fa-reddit"></i></a>
        </li>
        ...
        <li style="--x:6;--color:#ff0000">
            <a href="#"><i aria-hidden="true" class="fa-brands fa-youtube"></i></a>
        </li>
