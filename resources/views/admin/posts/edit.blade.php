            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.posts.update', $post->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="4">{{ $post->description }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="promo_price" name="promo_price" class="form-control" value="{{ $post->promo_price }}">
                    </div>

                    <div class="form-group">
                        <label for="shop_link">Shop Link</label>
                        <input type="text" id="shop_link" name="shop_link" class="form-control" value="{{ $post->shop_link }}">
                    </div>
                    ...
                    <div class="mt-3">
                        <button type="submit" class="btn btn-primary" title="Update Post">
